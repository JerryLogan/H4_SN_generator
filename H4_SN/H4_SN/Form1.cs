...
namespace H4_SN
{
    public partial class Form1 : Form
    {
        ...
        //test zone
        String[] template_content = new string[262];
        ...
        private void button1_Click(object sender, EventArgs e) //select template
        {
            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    //copy template_content
                    template_content[line_count] = lineline;
                    textBox5.Text += template_content[line_count];
                    textBox5.Text += "\r\n";
        ...
        private void button3_Click(object sender, EventArgs e) //help info
        {
